...
public class ListCafeListItem {
    ...
    public ListCafeListItem(String cafeList_cafeName, String cafeList_cafeAddress, String openTime, String tag1, String tag2, int cafeList_cafeImage, boolean check_user_flag) {
