...
//        NavigationUI.setupWithNavController(binding.navViewMain, navController);
    ...
    private void bindList() {         // fragment_list_search 페이지 리사이클러뷰 푸터 실험용 코드
        // List item 생성
        ArrayList<ListSearchItem> person = new ArrayList<>();

        person.add(new ListSearchItem("이디야커피 수원대점", "경기 화성시 봉담읍 와우안길 16"));
        person.add(new ListSearchItem("와우당", "경기 화성시 봉담읍 와우안길 10"));
        person.add(new ListSearchItem("-", "서울특별시 강남구 역삼동 논현로 539"));
        person.add(new ListSearchItem("옹느세자메", "서울특별시 용산구 이태원로54길 51"));
        person.add(new ListSearchItem("이디야커피 수원대점", "경기 화성시 봉담읍 와우안길 16"));
        person.add(new ListSearchItem("와우당", "경기 화성시 봉담읍 와우안길 10"));
        person.add(new ListSearchItem("-", "서울특별시 강남구 역삼동 논현로 539"));
        person.add(new ListSearchItem("옹느세자메", "서울특별시 용산구 이태원로54길 51"));
        ...
        // Adapter 추가
        ListSearchAdapter adapter = new ListSearchAdapter(person);
