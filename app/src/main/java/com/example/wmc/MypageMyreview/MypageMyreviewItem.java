...
public class MypageMyreviewItem {
    ...
    public MypageMyreviewItem(String reviewNickName, String level_and_location, String review_comment, int reviewProfile_image, int reviewImage, String good_count_textView) {
