...
public class HomeTag1ViewHolder extends RecyclerView.ViewHolder{
    ...
    public static int HOMETAG1_VIEW_TYPE = R.layout.item_home_taglist;

    public HomeTag1ViewHolder(@NonNull View itemView, final HomeTag1Adapter.OnItemClickEventListener_HomeTag1 a_itemClickListener) {
        super(itemView);
