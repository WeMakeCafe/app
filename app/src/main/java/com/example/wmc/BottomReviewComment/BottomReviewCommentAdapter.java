...
public class BottomReviewCommentAdapter extends RecyclerView.Adapter<BottomReviewCommentViewHolder>{
    ...
    public void onBindViewHolder(@NonNull BottomReviewCommentViewHolder viewHolder, int position) {
        ...
        Glide.with(bottom_reviewCommentFragment.getContext())
                .load(image_uri)
...
//                notifyDataSetChanged();
                ...
                if (image_uri.toString().contains("http")) { // 이미 서버에 올라가있는 사진은 DELETE처리
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(bottom_reviewCommentFragment.getContext());
                    ...
                    builder.setPositiveButton("예", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int id) {
                            ...
                            Cache cache = new DiskBasedCache(bottom_reviewCommentFragment.getActivity().getCacheDir(), 1024 * 1024); // 1MB cap
                            Network network = new BasicNetwork(new HurlStack());
                            requestQueue = new RequestQueue(cache, network);
                            requestQueue.start();

                            String get_reviewImage_url = bottom_reviewCommentFragment.getResources().getString(R.string.url) + "reviewImage";
                            ...
                            StringRequest stringRequest = new StringRequest(Request.Method.GET, get_reviewImage_url, new Response.Listener<String>() {
                                ...
                                public void onResponse(String response) {
                                    ...
                                    // 서버에서 이미지 삭제
                                    String delete_reviewImage_URL = bottom_reviewCommentFragment.getResources().getString(R.string.url) + "reviewImage/" + delete_reviewImage.toString();
