...
public class MypageReviewItem {
    ...
    public MypageReviewItem(String reviewNickName, String level_and_location, String review_comment, int reviewProfile_image, int reviewImage1, int reviewImage2, int reviewImage3, String good_count_textView) {
