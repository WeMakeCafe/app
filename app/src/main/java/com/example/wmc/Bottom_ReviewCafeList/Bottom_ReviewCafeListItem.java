...
public class Bottom_ReviewCafeListItem {
    ...
    public Bottom_ReviewCafeListItem(String cafeList_cafeName, String cafeList_cafeAddress, String openTime, String tag1, String tag2, String cafeList_cafeImage, boolean check_user_flag, Long get_cafe_num, Long get_bookmark_num) {
    ...
    public Long getGet_bookmark_num() {
        return get_bookmark_num;
    }

    public void setGet_bookmark_num(Long get_bookmark_num) {
        this.get_bookmark_num = get_bookmark_num;
    }
}
