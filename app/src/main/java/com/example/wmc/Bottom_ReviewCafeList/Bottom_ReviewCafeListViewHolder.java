...
public class Bottom_ReviewCafeListViewHolder extends RecyclerView.ViewHolder{
    ...
    public Bottom_ReviewCafeListViewHolder(@NonNull View itemView, final Bottom_ReviewCafeListAdapter.OnItemClickEventListener_ReviewCafeList itemClickListener_reviewcafeList) {
        super(itemView);
